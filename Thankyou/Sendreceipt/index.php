...
<div style="font-family: Trebuchet MS, sans-serif; padding: 20px; color: #333; max-width: 600px; margin: auto;">
    ...
    if ($mail->send()) {
    echo "<div style='font-family: Arial, sans-serif; padding: 15px; background-color: #ED1A3B; color: #FFFFFF; border: 1px solid #c3e6cb; border-radius: 5px;'>
            ✅ <strong>Success:</strong> Receipt has been sent to <strong>$user_email</strong>.
          </div>";
} else {
